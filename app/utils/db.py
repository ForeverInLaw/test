...
from sqlalchemy import create_engine, Column, Integer, String, Text, DECIMAL, ForeignKey, UniqueConstraint, func
...
DATABASE_URL = os.environ.get("DATABASE_URL", "postgresql+psycopg2://user:password@host:port/database")
